...
module.exports = function () {
    var Block = React.createClass({
        ...
        task2: function (event) {
            ...
            this.handleAnswerAndDisplayMessages({
                answer: {
                    ...
                    'Часть карты находится в одной из черных книге в зале. Йо-Хо-Хо и бутылка рома!!!',
                    goNext: 'Дальше',
        ...
        task3: function (event) {
            ...
            this.handleAnswerAndDisplayMessages({
                answer: {
                    ...
                    joke2: 'Отставить, поплыли дальше',
                ...
                nextTask: {
                    ...
                    'Ах, да, чуть не забыл, гадалка сказала, что видит этот предмет в месте, где всегда беспорядок. ' +
                    'К этому месту можно пройти от входа 9 лилипутов вперед, увидев свое отражение, повернуть направо, и ' +
                    'двигаться прямо до естественного источника света. ' +
                    'Сам не пойму о чем идет речь, но думаю, Вы решите это задание, ведь части карты еще у меня!',
                    handler: this.task4,
        ...
        task4: function (event) {
            ...
            this.handleAnswerAndDisplayMessages({
                answer: {
                    correctValue: 'Банана шамана',
                    joke1: 'Да чтож, это такое?!',
                    joke2: 'Ну, ладно, пошли дальше. Это еще не все!',
                    help: 'Да Вы молодцы! Сам черт не нашел бы эту черную метку во всем белом свете. Из вас получатся отличные пираты! ' +
                    'Ну хорошо, хорошо, не буду утомлять своими бессмысленными речами, часть карты спрятана у Вас под диваном.. Чики-пуки-барамбуки',
                    goNext: 'Поплыли дальше',
        ...
        task5: function (event) {
            ...
            this.handleAnswerAndDisplayMessages({
                answer: {
                    correctValue: 'Трех Слонов',
                    joke1: 'Упс, ошибочка...',
                    joke2: 'А может и не ошибочка',
                    help: 'Вот это да!!! С вашей помощью я стал еще богаче чем раньше! Конечно мне придется еще поискать эти сокровища на остове, но у меня просто нюх на золотишко и я быстро его найду! ' +
                    'Ах, да, вам надо сказать где часть карты ? Ммм.. дай-ка  подумать, кажется, я спрятал ее в почтовом ящике. Труля-ля',
                ...
                nextTask: {
                    ...
                    'Большой Русско-Белорусский Словарь, стр.275, стр.704, стр.259, стр.137, стр.21, стр.141, ь , стр.537, стр.95, стр.259, стр.275, ' +
                    'стр.494, стр.141, стр.21, стр.95, стр.95, ы , стр.677, стр.275, стр.704, стр.259, стр.137. Посмотрим, как Вы решите это задание!',
                    handler: this.task6,
        ...
        task6: function (event) {
            ...
            this.handleAnswerAndDisplayMessages({
                answer: {
                    correctValue: 'Огонь поможет тебе',
                    joke1: 'А вот и не скажу',
                    joke2: 'Так уж и быть, только не плачте',
                    help: 'Обалдеть! Вы прошли все задания и нашели последнюю часть карты? ' +
